  ...
  <a href="https://space.bilibili.com/1759955728" target="_blank" rel="noopener"
     style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 12px; min-width: 160px; flex: 1; max-width: 180px;
            background: rgba(251, 114, 153, 0.1); border: 1px solid rgba(251, 114, 153, 0.3);
            border-radius: 12px; color: #fb7299; text-decoration: none; font-size: 14px;
  ...
  <!-- QQ -->
  <a href="https://qm.qq.com/q/R0eekcJ6ue" target="_blank" rel="noopener"
     style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 12px; min-width: 160px; flex: 1; max-width: 180px;
            background: rgba(18, 183, 245, 0.1); border: 1px solid rgba(18, 183, 245, 0.3);
            border-radius: 12px; color: #12b7f5; text-decoration: none; font-size: 14px;
            transition: all 0.3s ease; backdrop-filter: blur(10px);">
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  <!-- GitHub 明暗模式适配 -->
  <a href="https://github.com/TheLittleQuteGDH" target="_blank" rel="noopener" class="github-btn"
     style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 12px; min-width: 160px; flex: 1; max-width: 180px;
  ...
  <!-- Telegram -->
  <a href="https://t.me/TheLittleQuteGDH" target="_blank" rel="noopener"
     style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 12px; min-width: 160px; flex: 1; max-width: 180px;
            background: rgba(0, 136, 204, 0.1); border: 1px solid rgba(0, 136, 204, 0.3);
            border-radius: 12px; color: #0088cc; text-decoration: none; font-size: 14px;
            transition: all 0.3s ease; backdrop-filter: blur(10px);">
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
