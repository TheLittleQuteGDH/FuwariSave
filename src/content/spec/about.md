...
<!-- 社交链接按钮组 - 等宽、居中、GitHub自适应暗黑模式 -->
<div class="social-links">
    <!-- B站 -->
    <a href="https://space.bilibili.com/1759955728" target="_blank" rel="noopener" class="social-btn bilibili">
    ...
    <!-- QQ -->
    <a href="https://qm.qq.com/q/R0eekcJ6ue" target="_blank" rel="noopener" class="social-btn qq">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- GitHub（自适应暗黑模式） -->
    <a href="https://github.com/TheLittleQuteGDH" target="_blank" rel="noopener" class="social-btn github">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- Telegram -->
    <a href="https://t.me/TheLittleQuteGDH" target="_blank" rel="noopener" class="social-btn telegram">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
<style>
    ...
    .social-btn {
        ...
        /* 等宽核心：flex-grow 平分空间，flex-basis 为 0 确保从同一起点分配 */
        flex: 1 0 0;
        /* 最小宽度防止按钮过窄，最大宽度防止过度拉伸 */
        min-width: 100px;
        max-width: 160px;
        /* 文字不换行，保持整洁 */
        white-space: nowrap;
    ...
    .bilibili {
        ...
        border-color: rgba(251, 114, 153, 0.30);
    }
    .bilibili:hover {
    ...
    .qq {
        ...
        border-color: rgba(18, 183, 245, 0.30);
    }
    .qq:hover {
